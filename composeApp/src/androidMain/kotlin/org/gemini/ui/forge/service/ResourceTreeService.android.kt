...
/**
 * 资源树服务的 Android 占位实现（待适配：遵循桌面版优先规范）。
 */
class AndroidResourceTreeService : ResourceTreeService {
 ...
 * Android 平台资源树服务工厂实现。
 */
actual fun createResourceTreeService(): ResourceTreeService = AndroidResourceTreeService()
