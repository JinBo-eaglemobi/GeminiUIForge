...
actual fun createGitService(): GitService = object : GitService {
    ...
    override suspend fun testConnection(repoUrl: String, credential: GitCredentialInfo): String? = "Browser 暂不支持 Git 操作"
    override suspend fun initAndBloblessFetch(
        targetDir: String,
        repoUrl: String,
        credential: GitCredentialInfo?,
        onLog: (String) -> Unit
    ): String? = "Browser 暂不支持 Git 操作"
    ...
    override suspend fun sparseCheckout(targetDir: String, paths: List<String>, onLog: (String) -> Unit): String? = "Browser 暂不支持 Git 操作"
    override suspend fun pullUpdates(targetDir: String, credential: GitCredentialInfo?, onLog: (String) -> Unit): String? = "Browser 暂不支持 Git 操作"
}
